...
This directory contains overlay patches for `submodules/how/` adhering to the Submodule Immutability Rule in `AGENTS.md`.

## Immutability Rules:
1. Submodules are 100% READ-ONLY. Zero direct edits inside `submodules/how/`.
