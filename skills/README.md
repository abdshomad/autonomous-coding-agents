...
|:---|:---|:---|:---|
| **1. Define** | [`spec-driven-development`](spec-driven-development/SKILL.md), [`how`](how/SKILL.md) | [`graphify`](graphify/SKILL.md) (AST query), [`archify`](archify/SKILL.md) (diagrams), [`ai-memory`](ai-memory/SKILL.md) (memory recall) | Research ingestion, codebase orientation, author PRD. |
