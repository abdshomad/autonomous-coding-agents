...
| **5. Review** | [`code-audit-and-refactor`](code-audit-and-refactor/SKILL.md), [`cyclomatic-complexity`](cyclomatic-complexity/SKILL.md) | `c` / `r` | Split files ≥256 LOC, refactor CC >10, audit security & `[DECISION]` rules. |
